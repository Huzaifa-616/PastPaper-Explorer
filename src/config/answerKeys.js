...
//   1. LEGACY_KEYS  — the original hand-typed keys (kept for safety)
//   2. generated    — produced by `python generate_mcq_keys.py`, which reads
//                     Paper 1 mark scheme PDFs in /public/papers automatically.
// Generated keys OVERRIDE legacy keys, so the pipeline is the source of truth.
// To add keys for new papers: drop the ms PDF in /public/papers, run the script.

import generated from './answerKeys.generated.json';
...
export const MCQ_ANSWER_KEYS = { ...LEGACY_KEYS, ...generated };
