    ...
    <>
      ...
      <div style={{ display:'flex',flexDirection:'column',height:'100vh',background:'var(--bg)',overflow:'hidden' }}>
        ...
        <div 
          ...
          onMouseLeave={(e) => { 
            // Fix: Only close if moving DOWN into the document. If moving UP out of window (to tabs), keep it open.
            if(isViewing && e.clientY > 10) setShowNav(false); 
          }}
        >
        ...
        {isViewing && !showNav && (
          <>
            {/* Desktop Horizontal Hover Trigger (Fix: Shrunk height to 8px) */}
            <div
