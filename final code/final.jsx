...
export default function App() {
  ...
  if (showStartup) return (
    <><GlobalStyles dark={dark}/><StartupScreen onSelectExplorer={handleSelectExplorer} onSelectTopicals={handleSelectTopicalsDashboard} onSelectLibrary={handleSelectLibraryDashboard} toggleTheme={toggleTheme} dark={dark}/></>
  );
